#import sys
#sys.path.insert (1,'C:\User\User\30daysofpython\day_10\country_data.py')
...
#for i in range(len(countries_data)):
   # a = a + len(countries_data[i]['languages'])
    #print(a)
